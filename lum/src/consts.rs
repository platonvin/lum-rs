use vulkanalia::{
    vk,
    vk::{ImageLayout, ShaderStageFlags},
};
...
pub const DEPTH_READ_ONLY_STENCIL_ATTACHMENT_OPTIMAL: vk::ImageLayout =
    ImageLayout::from_raw(1000117000);
pub const DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL: vk::ImageLayout =
    ImageLayout::from_raw(1000117001);
...
pub const TESSELLATION_CONTROL: vk::ShaderStageFlags =
    unsafe { ShaderStageFlags::from_bits_unchecked(1 << 1) };
pub const TESSELLATION_EVALUATION: vk::ShaderStageFlags =
    unsafe { ShaderStageFlags::from_bits_unchecked(1 << 2) };
...
pub const ALL_GRAPHICS: vk::ShaderStageFlags = unsafe {
    ShaderStageFlags::from_bits_unchecked(
        VERTEX.bits()
            | TESSELLATION_CONTROL.bits()
            | TESSELLATION_EVALUATION.bits()
            | GEOMETRY.bits()
            | FRAGMENT.bits(),
    )
};
...
pub const RAYGEN_KHR: vk::ShaderStageFlags =
    unsafe { ShaderStageFlags::from_bits_unchecked(1 << 8) };
pub const ANY_HIT_KHR: vk::ShaderStageFlags =
    unsafe { ShaderStageFlags::from_bits_unchecked(1 << 9) };
pub const CLOSEST_HIT_KHR: vk::ShaderStageFlags =
    unsafe { ShaderStageFlags::from_bits_unchecked(1 << 10) };
pub const MISS_KHR: vk::ShaderStageFlags =
    unsafe { ShaderStageFlags::from_bits_unchecked(1 << 11) };
pub const INTERSECTION_KHR: vk::ShaderStageFlags =
    unsafe { ShaderStageFlags::from_bits_unchecked(1 << 12) };
pub const CALLABLE_KHR: vk::ShaderStageFlags =
    unsafe { ShaderStageFlags::from_bits_unchecked(1 << 13) };
pub const SUBPASS_SHADING_HUAWEI: vk::ShaderStageFlags =
    unsafe { ShaderStageFlags::from_bits_unchecked(1 << 14) };
pub const CLUSTER_CULLING_HUAWEI: vk::ShaderStageFlags =
    unsafe { ShaderStageFlags::from_bits_unchecked(1 << 19) };
pub const ALL: vk::ShaderStageFlags =
    unsafe { ShaderStageFlags::from_bits_unchecked(i32::MAX as u32) };
